...
* [Jenkins](https://github.com/jakubrylko/cypress-automation-framework/blob/main/Jenkinsfile) - configuration file used to trigger local and parallel [Jenkins](https://www.jenkins.io/download/) jobs.
